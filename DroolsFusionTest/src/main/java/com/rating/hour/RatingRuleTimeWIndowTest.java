...
public class RatingRuleTimeWIndowTest {
	@Test
...
//			ksession.dispose();
	...
	public static final void main(String[] args) {
		RatingRuleTimeWIndowTest fusionTest = new RatingRuleTimeWIndowTest();
...
//		fusionTest.testTemporal();
	...
	public static class  Statistic{
		...
		private String lpn;
		private List<Transaction> transactions = new ArrayList<RatingRuleTimeWIndowTest.Transaction>();
