...
//				System.out.println(tran.detnPoint);
				if(i == 0){
...
//				clock.advanceTime( i * 10, TimeUnit.MINUTES );
...
//		fusionTest.testTemporal();
	...
	private static KnowledgeBase readKnowledgeBaseStream() throws Exception {
		...
		kbuilder.add(ResourceFactory.newClassPathResource("com/rating/hour/RatingRule.drl"), ResourceType.DRL);
	...
	public static class  Statistic{
		...
		private String lpn;
		private List<Transaction> transactions = new ArrayList<RatingRuleTest.Transaction>();
